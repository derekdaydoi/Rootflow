...
var CACHE = 'rootflow-cache-v11-2026-08-25-final';
...
self.addEventListener('fetch', function (e) {
  ...
  var core = req.mode === 'navigate' || /\/(index\.html|styles\.css|v4\.css|app\.js|v4-ui\.js|domain\.js|v3-domain\.js|v4-domain\.js|v3-compat\.js|v3-i18n\.js|v4-i18n\.js|store\.js|v3-store\.js|selftest\.js|manifest\.json)$/.test(u.pathname);
