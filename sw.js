...
var CACHE='rootflow-ui-2026-09-09-brand-r5-theme';
var ASSETS=['./','./index.html','./styles.css','./capital.css','./brand/rootflow-theme.css?v=20260909-brand-r5-theme','./brand/rootflow-splash.css?v=20260909-brand-r4-norings','./brand/rootflow-mark.png?v=20260909-brand-r3','./brand/rootflow-icon.png?v=20260909-brand-r5-theme','./operating-policy.js','./domain.js','./cashflow-domain.js','./capital-domain.js','./store.js','./selftest.js','./capital-ui.js','./app.js','./manifest.json?v=20260909-brand-r5-theme','./vendor/react.production.min.js','./vendor/react-dom.production.min.js'];
