...
(function (global) {
  ...
  function run() {
    ...
    /* --- 29. Chỉ trả lãi không làm giảm dư gốc --- */
    var interestOnlyContract = { id: 'io', type: 'payable', originalPrincipal: 100000000 };
    var interestOnlyFlows = [
      { id: 'io1', contractId: 'io', kind: 'repay', accountId: 'tc', counterAccountId: 'tl', amount: 2000000, principalAmount: 0, borrowingCost: 2000000, date: '2026-09-02', confirmed: true, skipped: false },
      { id: 'io2', contractId: 'io', kind: 'repay', accountId: 'tc', counterAccountId: 'tl', amount: 100000000, principalAmount: 100000000, borrowingCost: 0, date: '2026-12-01', confirmed: false, skipped: false, autoGenerated: true },
      { id: 'io3', contractId: 'io', kind: 'repay', accountId: 'tc', counterAccountId: 'tl', amount: 20000000, principalAmount: 20000000, borrowingCost: 0, date: '2026-11-01', confirmed: false, skipped: false }
    ];
    var ioPaid = D.contractPaymentTotals(interestOnlyContract, interestOnlyFlows);
    var ioCommitted = D.contractPaymentTotals(interestOnlyContract, interestOnlyFlows, { includePlanned: true, excludeAuto: true });
    check('Interest-only đã trả đúng phần lãi', [ioPaid.principal, ioPaid.interest], [0, 2000000]);
