  ...
  function AccountForm(props) {
    ...
    return h(React.Fragment, null,
      ...
      showContract ? h('div', { className: 'form-divider' },
        ...
        (form.actualInterestMethod === 'flat' || form.actualInterestMethod === 'reducing_balance') ? h(Field, { label: 'Lãi suất / tháng' }, h(TextInput, { inputMode: 'decimal', value: form.interestRate, onChange: function (e) { set('interestRate', e.target.value); }, placeholder: '2.0%' })) : null,
